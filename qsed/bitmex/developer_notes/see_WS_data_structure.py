...
import time
import logging
from bitmex.APIKeyAuth import generate_nonce, generate_signature
...
if __name__ == '__main__':
    ...
    with open('bitmex/developer_notes/accounts.json') as f:
        acc = json.load(f)
    ...
    what = 'instrument'  # <<<<------- change this to see subscribed data structure
